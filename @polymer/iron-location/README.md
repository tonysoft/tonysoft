...
<html>
  <head>
    <script type="module">
      import 'https://unpkg.com/tonysoft@^1.2.5/@polymer/iron-location/iron-location.js';
    </script>
  </head>
  <body>
    <iron-location
...
<html>
  <head>
    <script type="module">
      import 'https://unpkg.com/tonysoft@^1.2.5/@polymer/polymer/lib/elements/dom-bind.js';
      import 'https://unpkg.com/tonysoft@^1.2.5/@polymer/iron-location/iron-location.js';
      import 'https://unpkg.com/tonysoft@^1.2.5/@polymer/iron-location/iron-query-params.js';
    </script>
  </head>
  <body>
    <dom-bind>
