...
class MarkdownProseEditor extends PolymerElement {
    static get template() {
        ...
        <div id="editor" on-click="focusOnEditor" class$="main noSelect [[hasBorder(border)]]" style="position: relative; width: [[setWidth(width)]]; max-width: [[setMaxWidth(maxWidth)]]; height: [[setHeight(height)]]; overflow: auto;">
        </div>
        <div>
            ...
            elements.forEach(function(element) {
                ...
                if (!element.style.width) {
                    if (parentNode.style.width) {
                        ...
                        element.style.width = parentNode.offsetWidth - (context.border ? 12 : 10) + "px";
                    }
                }
                if (!element.style.height) {
                    if (parentNode.style.height) {
                        ...
                        element.style.height = parentNode.offsetHeight - (context.border ? 12 : 10) + "px";
                    }
                }
            })
