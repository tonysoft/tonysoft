...
/**
 * `flex-item-list`
 * A list created from an array of items compatible with a Vega Tree.
 *
 * @customElement
 * @polymer
 * @demo demo/index.html
 */
class FlexItemList extends PolymerElement {
    static get template() {
      return html`
        <style>
          :host {
...
window.customElements.define('flex-item-list', FlexItemList);
